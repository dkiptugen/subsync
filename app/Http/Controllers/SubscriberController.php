        ...
        public function store(StoreSubscriber $request, $product)
            {
                ...
                if ($validator)
                    ...
                    {
                        return self::fail('Subscriber Update', ' failed', route('product.subscriber.index', $product));
                    }
            }
        ...
        public function deactivate($productId, $userId)
            {
                ...
                return self::fail('user Deactivation', 'deactivation failed', route('product.subscriber.index', $productId));
            }
     ...
     */
        ...
        public function change_password(ChangePassword $request, $productId, $userId)
            ...
            public function upload(Request $request)
            {
                ...
                {
                    return self::fail('Subscribers', $e->validator->errors()->first(), route('subscribers.bulk'));
                }
