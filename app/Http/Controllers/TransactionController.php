                ...
                try
                    {
                        ...
                        return self::fail('Transaction', 'Failed to save', route('subscription.transaction.index', [$sub,$id]));
                    }
                catch (\Exception $e)
                    {
                        return self::fail('Transaction', $e->getMessage(), route('subscription.transaction.index', [$sub,$id]));
                    }
