...
class SubscriberSubsController extends Controller
{
    ...
    public function store(Request $request, $userid)
    {
        ...
        try {
            ...
            if (is_null($rate)) {
                return self::failed('Subscription', 'This subscription type is not available for this product', route('user.subscription.index', $userid));
            } else {
            ...
            return self::failed('Subscription', $e->getMessage(), route('user.subscription.index', $userid));
        }
        ...
        try {
            ...
            if (is_null($rate)) {
                ...
                if ($subg) {
                    ...
                    return self::failed('Subscription', 'subs failed', route('user.subscription.index', $userid));

                }

                return self::failed('Subscription', 'failed', route('user.subscription.index', $userid));
            }
