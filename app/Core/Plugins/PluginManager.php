...
class PluginManager
{
    ...
    public function installFromUploadedArchive(UploadedFile $archiveFile, bool $enable = true): array
    {
    ...
    protected function locatePluginSourceFromExtractedArchive(string $extractPath): array
    {
        $candidates = [];
    ...
    protected function extractUploadedArchive(UploadedFile $archiveFile, string $sourcePath, string $destination): void
    {
    ...
    protected function extractZipArchive(string $sourcePath, string $destination): void
    {
        $zip = new ZipArchive;
    ...
    protected function extractTarArchive(string $sourcePath, string $destination): void
    {
        try {
    ...
    protected function safeExtractZip(ZipArchive $zip, string $destination): void
    {
    ...
    protected function assertArchiveExtractionIsSafe(string $destination): void
    {
    ...
    protected function runPluginMigrations(array $plugin): void
    {
    ...
    protected function migrationPathsFor(array $plugin): array
    {
        ...
        return array_values(array_unique(array_filter($paths, static fn (string $path): bool => File::isDirectory($path))));
    }

    protected function pluginBasePath(array $plugin): string
    {
