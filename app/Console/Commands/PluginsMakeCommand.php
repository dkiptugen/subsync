...
class PluginsMakeCommand extends Command
{
    ...
    public function handle(PluginManager $pluginManager): int
    {
        ...
        $pluginTitle = is_string($title) && $title !== '' ? $title : Str::headline($studlyName);
    ...
    protected function writePluginFiles(
        ...
        $tableName = Str::snake($pluginName).'_plugin_settings';
        ...
        File::put("{$pluginPath}/plugins.json", $this->buildManifest(
