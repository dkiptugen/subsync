...
<head>
    ...
    <title>New Corporate Subscription</title>
    <meta name="viewport"
                        ...
                        <table border="0"
                            ...
                            <tr>
                                <td style="color: #153643; font-family: Arial, sans-serif;">
                                    <h1 style="font-size: 18px; margin: 0;">Hi team,</h1>
                                </td>
                            </tr>
                            <tr>
                                <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                                    <p><b>{{ $mail->corporate }}</b> has been assigned a subscription of {{ $mail->product }} that runs from <b>{{ $mail->startdate }}</b> to <b> {{ $mail->enddate }}</b> for <b>{{ $mail->users }} Users</b></p>
                                    <p>The subscription was activated by {{ $mail->activator }} at {{ date('d-m-Y H:i:s') }}</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                                    <p>Kind Regards,</p>
                                    <p>Unified Subscription System</p>
                                </td>
                            </tr>
                                ...
                                <td align="right">
                                    <table border="0"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('user.unsubscribe',$user->id??0) }}"
