...
<p>This is to inform you that your subscription for {{ $product->product_name }}
   will expire on <b>{{ Carbon::parse($expirydate)->format('d, M Y h:iA' ) }}</b>.</p>

<p>We invite you to renew your subscription to ensure uninterrupted access to our exclusive content. Click the link below to renew your subscription.
</p>
...
<p> For help, check out our FAQ page (add FAQ link - https://www.monitor.co.ug/uganda/frequently-asked-questions-1934580). For assistance, email customercareug@ug.nationmedia.com or call +256312301230
