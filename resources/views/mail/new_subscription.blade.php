						...
						<table border="0"
							...
							<tr>
								<td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
									...
									<p>Thank you for Subscribing to Nation and supporting us in our journey to Empower Africa through our informed,
										unbiased and comprehensive coverage of news and events.</p>

									<p>Publication Name: {{ $product->product_name??'epaper' }}</p>

									<p>{{ optional($product)->identifier }}</p>

									<p>
										To start reading click here <a href="{{ $product->product_link??'https://epaper.nation.africa' }}"
												class="text-primary">{{ $product->product_link??'https://epaper.nation.africa' }}</a>
									</p>

									<p>
										Have a friend who would absolutely love Nation? Tell them to sign up right here.
									</p>

									<p>
										For any issues or queries email us on epaper@ke.nationmedia.com or call 0790111111
									</p>
