        ...
        <div class="sidebar-content  js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                @if(auth()->user()->type =='owner')
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link fw-bold " href="{{ route('subscription-approval.index') }}">
                    ...
                    <li class="sidebar-item">
                        <a href="#whitelist"
                           ...
                           class="fw-bold sidebar-link collapsed">
                            <i class="align-middle"
                ...
                @else
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link fw-bold" href="{{ route("user.logs.index",['user'=>0]) }}">
