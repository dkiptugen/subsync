    ...
    <div class="col-12">
        <div class="card w-100">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                <h3 class="card-title my-0 text-nation">Add Subscription</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('subscription.store' , 0) }}" method="post" class="form form-horizontal create-form">
                    ...
                    <div class="row mb-3">
                        ...
                        <!-- /.col -->
                        <div class="col">
                            <label for="bundle" class="control-label">Bundle Type</label>
                            <!-- /.control-label -->
                            <select name="bundle" id="bundle" class="form-control select2">
